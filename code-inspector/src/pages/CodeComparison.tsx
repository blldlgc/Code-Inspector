...
interface ComparisonResult {
  ...
  codeBERTSimilarityPercentage: number;
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                        ...
                                                        <div className="p-4 rounded-lg border bg-card text-card-foreground shadow-sm">
                                                            <div className="space-y-2">
                                                                ...
                                                                <div className="flex items-center justify-between">
                                                                    <p className="text-2xl font-bold text-primary">
                                                                        {result.codeBERTSimilarityPercentage.toFixed(2)}%
                                                                    </p>
                                                                    <div className={`px-2 py-1 rounded-full text-xs ${
                                                                        result.codeBERTSimilarityPercentage > 80 ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200' :
                                                                        result.codeBERTSimilarityPercentage > 50 ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' :
                                                                        'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200'
                                                                    }`}>
                                                                        {result.codeBERTSimilarityPercentage > 80 ? 'High' :
                                                                         result.codeBERTSimilarityPercentage > 50 ? 'Medium' : 'Low'}
                                                                    </div>
                                                                </div>
                                                                <p className="text-xs text-muted-foreground">
